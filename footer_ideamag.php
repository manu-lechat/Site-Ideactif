...
<footer class="footer_ideamag">
  ...
  <section class="layout_container">
    <a href="#" class="bt_gotop bt_bump">
      <img src="img/iconWhite_gotop_hover.svg" class="hover">
      <img src="img/iconWhite_gotop.svg" alt="">
    </a>
    <a href="index.php" class="link">ALLER SUR NOTRE SITE</a>
    <p class="signature">@ 2015 - IDEACTIF</p>
    <div class="social">
